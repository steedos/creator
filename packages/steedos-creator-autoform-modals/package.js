...
Package.on_use(function (api) {
  ...
  api.add_files('lib/client/coreform-table/steedos-table-modal.html', 'client');
  api.add_files('lib/client/coreform-table/steedos-table-modal.js', 'client');
  ...
  api.add_files('lib/client/coreform-table/2_steedos_data_format.js', 'client');
});
