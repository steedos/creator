...
jQuery.notification = (function($, window) {
    ...
    var W3CNotification = (function() {
        ...
        var Notification = function(title, options) {
            ...
            instance.requireInteraction = options.requireInteraction ? options.requireInteraction : false;
     ...
     * @param {Boolean}  [options.requireInteraction] A Boolean indicating that a notification should remain active until the user clicks or dismisses it, rather than closing automatically
     *
     * @example
     *
    ...
    var exports = function(options) {
        ...
        requestPermission(function() {
            ...
            if (isFinite(options.timeout) && !options.requireInteraction) {
