...
! function(root, factory) {
    ...
    localization.loadMessages({
        ...
        'dxScheduler-recurrenceRepeatDaily': '日(s)',
        'dxScheduler-recurrenceRepeatWeekly': '周(s)',
        'dxScheduler-recurrenceRepeatMonthly': '月(s)',
        'dxScheduler-recurrenceRepeatYearly': '年(s)',
        ...
        'dxScheduler-recurrenceRepeatCount': '事件(s)',
        ...
        'dxFilterBuilder-filterOperationIsBlank': '空白',
        'dxFilterBuilder-filterOperationIsNotBlank': '不是空白'
        }
    })
});
